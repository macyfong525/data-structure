...
//        return bstSearch(getRootNode(), anEntry);
//    }
//
//    public boolean bstSearch(BinaryNode<T> node, T searchObj) {
//        if (node == null)
//            return false;
//        else if (searchObj.equals(node.getData()))
//            return true;
//        else if (searchObj.compareTo(node.getData()) < 0)
